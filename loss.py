...
class Loss(nn.Module):
    def __init__(self):
        ...
        self.mse = YOLOMSELoss()
#        self.entropy = nn.CrossEntropyLoss()
        self.bce = nn.BCEWithLogitsLoss()
        self.sigmoid = nn.Sigmoid()

        self.lamada_noobj = 0.5
        self.lamada_coordinate = 5
    ...
    def forward(self, prediction, target):
        ...
        obj_loss = self.bce(prediction[..., 4][obj], target[..., 4][obj])
        ...
        return (noobj_loss + obj_loss + class_loss + coordinate_loss)
